...
```ts
import { useCreateProfileData, useUpdateMyProfile, useDeleteMyProfile, useGetMyProfile, useListAllProfiles, useCreateProject, useUpdateProject, useDeleteProject, useGetProject, useListMyProjects } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateProfileData(createProfileDataVars);

const { data, isPending, isSuccess, isError, error } = useUpdateMyProfile(updateMyProfileVars);

const { data, isPending, isSuccess, isError, error } = useDeleteMyProfile();

const { data, isPending, isSuccess, isError, error } = useGetMyProfile();

const { data, isPending, isSuccess, isError, error } = useListAllProfiles();
...
```js
import { createProfileData, updateMyProfile, deleteMyProfile, getMyProfile, listAllProfiles, createProject, updateProject, deleteProject, getProject, listMyProjects } from '@dataconnect/generated';


// Operation CreateProfileData:  For variables, look at type CreateProfileDataVars in ../index.d.ts
